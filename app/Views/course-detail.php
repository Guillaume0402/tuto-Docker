            ...
            <div class="card card-custom mb-4">
                ...
                <div class="card-body">
                    <?php if (isset($moduleContent['readme']) && $moduleContent['readme']): ?>
                        <!-- Contenu du README markdown converti -->
                        <div class="module-content">
                            ...
                            // Si pas trouvé dans les chapitres, essayer avec regex
                            if (!$objectivesFound && preg_match('/## 🎯 Objectifs pédagogiques\s*\n\n(.*?)\n\n##/s', $moduleContent['readme'], $matches)) {
                                echo "<h4>Objectifs pédagogiques</h4>";
                                echo "<div class='objectives'>" . nl2br(htmlspecialchars($matches[1])) . "</div>";
                                $objectivesFound = true;
                            }
                            ?>
                        </div>
                        ...
                        foreach ($chaptersToShow as $index => $chapter):
                            ...
                            <div id="collapse<?= $chapterId ?>" class="accordion-collapse collapse <?= $index === 0 ? 'show' : '' ?>" data-bs-parent="#chaptersAccordion">
                                <div class="accordion-body">
                                    ...
                                    <?php elseif (isset($chapter['topics'])): ?>
                                        <!-- Contenu sous forme de liste de sujets -->
